...
public class TicketsNuevos {

    private String ID, Titulo, Fecha, Usuario, Departamento, Incidencia, Gravedad, Version, Descripcion, Archivo, Etapa, Archivado;

    public TicketsNuevos(String ID, String titulo, String fecha, String usuario, String departamento, String incidencia, String gravedad, String version, String descripcion, String archivo, String etapa, String archivado) {
        this.ID = ID;
        this.Titulo = titulo;
        this.Fecha = fecha;
